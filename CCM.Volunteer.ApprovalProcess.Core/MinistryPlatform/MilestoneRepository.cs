...
namespace CCM.Volunteer.ApprovalProcess.Core.MinistryPlatform
{
    public class MilestoneRepository : IMilestoneRepository
    {
        ...
        {
            return dataContext.GetMilestones(contactID);
        }

        public int AddNewMilestone(int participantID, int milestoneID, int programID)
        {
            return dataContext.InsertRecord<ParticipantMilestone>( 
                new ParticipantMilestone
                { 
